...
public:
    ...
    static QString encodeAesOnECB(QString originText,QString passWord,Aes pswBytesSize);
    static QString decodeAesOnECB(QString encodeText,QString passWord,Aes pswBytesSize);
    static QString encodeAesOnCBC(QString originText, QString passWord, QString ivStr,Aes pswBytesSize);
    static QString decodeAesOnCBC(QString encodeText, QString passWord, QString ivStr,Aes pswBytesSize);
private:
    //模拟哈希Tiger-192(24字节)算法
    //原理：对Qt自带的Sha384(48字节)算法所得结果进行邻项归并
    static QByteArray hash192(QByteArray originBytes);
signals:
public slots:
